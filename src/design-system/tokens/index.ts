...
export const colors = {
  ...
  text: {
    ...
    disabled: token('colors.text.disabled'),
    inverse: token('colors.text.inverse'),
    link: token('colors.text.link'),
    linkHover: token('colors.text.linkHover'),
    error: token('colors.text.error'),
    success: token('colors.text.success'),
    warning: token('colors.text.warning'),
  },
  background: {
    default: token('colors.bg.canvas'),
    paper: token('colors.bg.paper'),
