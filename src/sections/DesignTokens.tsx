    ...
    >
      ...
      <div style={{ marginTop: spacing.scale[8] }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.scale[3], marginTop: spacing.scale[2] }}>
            <div style={{ padding: spacing.scale[3], backgroundColor: primitive.white, borderRadius: radii.borderRadius.base, border: `${borders.width.thin} solid ${primitive.gray[300]}` }}>
          ...
          <div
            style={{
              ...
              borderRadius: radii.borderRadius.base,
              border: `${borders.width.thin} solid ${primitive.blue[300]}`,
            }}
          >
          ...
          <div style={{ marginTop: spacing.scale[4], padding: spacing.scale[3], backgroundColor: primitive.gray[50], borderRadius: radii.borderRadius.base, border: `${borders.width.thin} solid ${primitive.gray[300]}` }}>
