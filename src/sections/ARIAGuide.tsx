  ...
  return (
    <section
      ...
      style={{
        ...
        border: `${borders.width.thin} ${borders.style} ${colors.border.default}`,
        maxWidth: '100%',
        overflowX: 'hidden',
    ...
    >
      <h2 style={{
        ...
        fontWeight: 'bold',
        borderBottom: `${borders.width.thick} ${borders.style} ${primitive.pink[500]}`,
      ...
      <div style={{
        ...
        borderRadius: radii.borderRadius.lg,
        border: `${borders.width.base} ${borders.style} ${primitive.blue[200]}`,
      }}>
        <h3 style={{
          marginTop: 0,
          marginBottom: spacing.scale[4],
        ...
        <div style={{ display: 'grid', gap: spacing.scale[4] }}>
          <div style={{
            ...
            border: `${borders.width.thin} ${borders.style} ${primitive.blue[200]}`,
          }}>
            <h4 style={{
              marginTop: 0,
        ...
        <div style={{
          ...
          border: `${borders.width.base} ${borders.style} ${primitive.black}`,
          borderRadius: radii.borderRadius.md,
      ...
      <div style={{ marginTop: spacing.scale[8] }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.thin} ${borders.style} ${primitive.pink[200]}`,
            minWidth: 0
          }}>
...
<section aria-labelledby="section-title">
  {/* セクションの内容 */}
          ...
          <div style={{
            ...
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.thin} ${borders.style} ${primitive.green[200]}`,
            minWidth: 0
          }}>
...
<span id="password-hint">
  8文字以上、英数字を含む
          ...
          <div style={{
            ...
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.thin} ${borders.style} ${primitive.orange[200]}`,
            minWidth: 0
          }}>
            ...
            <div style={{
              ...
              <div style={{ overflowX: 'auto' }}>
                ...
                <thead>
                  <tr style={{ borderBottom: `${borders.width.base} ${borders.style} ${primitive.orange[200]}` }}>
                ...
                <tbody>
                  <tr style={{ borderBottom: `${borders.width.thin} ${borders.style} ${primitive.orange[100]}` }}>
...
>
  セクションタイトル
          ...
          <div style={{
            ...
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.thin} ${borders.style} ${primitive.gray[300]}`,
            minWidth: 0
          }}>
...
<div role="navigation" aria-label="...">
  {/* ナビゲーション */}
          ...
          <div style={{
            ...
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.thin} ${borders.style} ${primitive.red[200]}`,
          }}>
        ...
        element: (
          <div>
            <input
              ...
              style={{
                padding: spacing.scale[2],
                border: `${borders.width.base} ${borders.style} ${primitive.red[500]}`,
                borderRadius: radii.borderRadius.md,
                width: "100%",
              }}
            />
        ...
        {(Object.keys(examples) as Array<keyof typeof examples>).map((key) => (
          <button
            ...
            style={{
              ...
              border: `${borders.width.base} ${borders.style} ${selectedExample === key ? primitive.pink[500] : primitive.gray[300]}`,
              borderRadius: radii.borderRadius.md,
      ...
      >
        ...
        <div
          style={{
            ...
            backgroundColor: primitive.white,
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.base} ${borders.style} ${primitive.red[300]}`,
            minWidth: 0
          }}
        >
          <div
        ...
        <div
          style={{
            ...
            backgroundColor: primitive.white,
            borderRadius: radii.borderRadius.md,
            border: `${borders.width.base} ${borders.style} ${primitive.green[300]}`,
            minWidth: 0
          }}
        >
          <div
    ...
    >
      ...
      <div style={{ marginTop: spacing.scale[4], display: "flex", gap: spacing.scale[4], alignItems: "center", flexWrap: "wrap" }}>
        <button
          ...
          style={{
            padding: spacing.scale[3],
            border: `${borders.width.base} ${borders.style} ${primitive.blue[500]}`,
            borderRadius: radii.borderRadius.md,
            backgroundColor: primitive.white,
